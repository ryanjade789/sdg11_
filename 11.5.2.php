...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_5_2` (`ppa`, `title`, `des`,`cost`,`fund`,`points`) 
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_5_2";
...
<title>11.5.2 | Promote sustainable commuting</title>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.5.2 Promote sustainable commuting</h3>
...
<div class="form-group">
      <label for="ppa" class="text-center ">Total number of PPAs that promotes sustainable commuting:</label>
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 50px;">Total number of PPAs that promotes sustainable commuting:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_5_2`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_5_2`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.5.2.php?update&green_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.5.2.php?delete={$id}' class='btn btn-danger'>
