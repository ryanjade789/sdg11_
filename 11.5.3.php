...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_5_3` (`ppa`, `title`, `des`,`cost`,`fund`,`points`) 
            VALUES ('$ppa','$title','$des','$cost','$fund','$points')";
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_5_3";
...
<title>11.5.3 | Allow remote working</title>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.5.3 Allow remote working</h3>
  <p>Promote or allow telecommuting or remote working for employees as a
matter of policy or standard practice, or offer a condensed working
week to reduce employee commuting.</p>
...
<div class="form-group">
      <label for="ppa" class="text-center ">Total number of PPAs that allow remote working:</label>
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 50px;">Total number of PPAs that allow remote working:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_5_3`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_5_3`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.5.3.php?update&green_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.5.3.php?delete={$id}' class='btn btn-danger'>
                          <i class='fa fa-trash'></i>
                      </a>
                      </td>";

            /*    echo "<td class='text-center'>
                          <a href='delete11.5.3.php?delete={$id}' class='btn btn-danger'>
                              <i class='fa fa-trash'></i>
                          </a>
                      </td>";
                echo "</tr>"; 
