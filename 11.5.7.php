...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_5_7` (`ppa`, `title`, `des`,`cost`,`fund`,`points`) 
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_5_7";
...
<title>11.5.7 Pedestrian priority on campus</title>
...
<div class="main">
  <h2>SDG 4 QUALISDG 11 Sustainable Cities and Communities</h2>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.5.7 Pedestrian priority on campus</h3>
  <p>Prioritize pedestrian access on campus.</p>

  <p>Total number of pedestrian access in campus:<b>7</b></p>
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 50px;">Total number of PPAs prioritizing pedestrian access in the campus:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_5_7`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_5_7`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.5.7.php?update&green_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.5.7.php?delete={$id}' class='btn btn-danger'>
