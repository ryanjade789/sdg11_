...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_5_5` (`appa`,`ppa`,`mppa`,`fppa`, `title`, `des`,`cost`,`fund`,`points`) 
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_5_5";
...
<title>11.5.5 | Affordable housing for employees</title>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.5.6 Affordable housing for employee</h3>
  <p>Provide affordable housing for employee</p>

  <p>Total number of female employee who live in their own house: <b>88</b></p>
<p>Total number of male employee who live in their own house: <b>99</b></p>
<p>Total number of employee who live in their own house: <b>187</b></p>
<p>Total number of female employee who are living with their relatives: <b>1</b></p>
<p>Total number of male employee who are living with their relatives: <b>6</b></p>
<p>Total number of employee who are living with their relatives: <b>7</b></p>
<p>Total number of female employee who stays at the boarding house: <b>1</b></p>
<p>Total number of male employee who stays at the boarding house: <b>1</b></p>
<p>Total number of employee who stays at the boarding house: <b>2</b></p>
<p>Total number of female employee who rents apartment: <b>2</b></p>
<p>Total number of male employee who rents apartment: <b>2</b></p>
<p>Total number of employee who rents apartment: <b>4</b></p>
<p>Total number of female employee who stays at the dormitory: <b>2</b></p>
<p>Total number of male employee who stays at the dormitory: <b>4</b></p>
<p>Total number of employee who stays at the dormitory: <b>6</b></p>
<p> </p>
<p><b>90.76%</b> of the employee population live in their own house.</p>
<p><b>3.40%</b> of the employee population are living with their relatives.</p>
<p><b>0.97%</b> of the employee population stays at the boarding house.</p>
<p><b>1.94%</b> of the employee population rent in the apartment.</p>
<p><b>2.91%</b> of the employee population stays at the dormitory.</p>
...
<div class="table-container">
  ...
  <th scope="col" style="width: 50px;">Total number of PPAs for affordable housing for employees:</th>
      <th scope="col" style="width: 50px;">Total number of employees provided with housing:</th>
      <th scope="col" style="width: 50px;">Male employees provided with housing:</th>
      <th scope="col" style="width: 50px;">Female employees provided with housing:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_5_5`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_5_5`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.5.5.php?update&green_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.5.5.php?delete={$id}' class='btn btn-danger'>
                          <i class='fa fa-trash'></i>
                      </a>
                      </td>";

            /*    echo "<td class='text-center'>
                          <a href='delete11.5.5.php?delete={$id}' class='btn btn-danger'>
                              <i class='fa fa-trash'></i>
                          </a>
                      </td>";
                echo "</tr>"; 
