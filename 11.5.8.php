...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_5_8` (`ppa`,`points`) 
            VALUES ('$ppa','$points')";
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_5_8";
...
<title>11.5.8 | Local authority collaboration regarding planning and development</title>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.5.8 Local authority collaboration regarding planning and
development</h3>
  <p>Work with local authorities to address planning issues and
development, including ensuring that local residents are able to access
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_5_8`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_5_8`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.5.8.php?update&green_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.5.8.php?delete={$id}' class='btn btn-danger'>
