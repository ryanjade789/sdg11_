...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_5_10` (`title`, `des`,`cost`,`fund`) 
            VALUES ('$title','$des','$cost','$fund')";
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_5_10";
...
<title>11.5.10 | Build on brownfield sites</title>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.5.10 Build on brownfield sites</h3>
  <p>Build on brownfield sites, where possible. This could be policies and
practices that the campus chose to adhere to, or from evidence of prior
development.</p>
...
qualifications to teach at primary level.</p> -->
    ...
    <div class="form-group">
      <label for="title">Total number of policies and/or plans in building infrastructure on
brownfield sites:</label>
      <textarea class="form-control" id="title" name="title" rows="1" required></textarea>
    </div>
    <div class="form-group">
      <label for="des">Total number of campus infrastructure built on brownfield sites:</label>
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 50px;">Total number of policies and/or plans in building infrastructure on
brownfield sites:</th>
      <th scope="col" style="width: 50px;">Total number of campus infrastructure built on brownfield sites:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_5_10`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_5_10`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.5.10.php?update&green_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.5.10.php?delete={$id}' class='btn btn-danger'>
