...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_5_9` (`ppa`,`ppb`,`points`) 
            VALUES ('$ppa','$ppb','$points')";
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_5_9";
...
<title>11.5.9 | Planning development-new build standards</title>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.5.9 Planning development-new build standards</h3>
  <p>Build new buildings to sustainable standards. This could be policies
and practices that the campus chose to adhere to, or from evidence of
prior development.</p>
...
<div class="form-group">
      <label for="ppa" class="text-center ">Total number of policies and/or plans in adhering to sustainable
standards of new builds:</label>
      <textarea class="form-control" id="ppa" name="ppa" rows="1" required></textarea>
    </div>
    <div class="form-group">
      <label for="ppb" class="text-center ">Total number of campus practices for sustainable standards of new
builds:</label>
      <textarea class="form-control" id="ppb" name="ppb" rows="1" required></textarea>
    </div>
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 50px;">Total number of policies and/or plans in adhering to sustainable
standards of new builds:</th>
       <!--    <th scope="col" style="width: 30px;">#</th> -->
       <th scope="col" style="width: 50px;">Total number of campus practices for sustainable standards of new
builds:</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_5_9`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_5_9`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.5.9.php?update&green_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.5.9.php?delete={$id}' class='btn btn-danger'>
