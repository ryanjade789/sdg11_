...
if(isset($_GET['green_id'])) //the green_id came from 11.3.4.php which was declared as variable to edit record
    {
     ...
     $query = "SELECT * FROM `tbl11_5_8` WHERE `id` = $green_id";
...
<form method="POST">
  ...
  <div class="form-group">
    <label for="ppa" class="text-center">Total number of collaborations with local authority for the affordable
housing for employees and students:</label>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../11.5.8.php';">
