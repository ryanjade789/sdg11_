...
if(isset($_GET['green_id'])) //the green_id came from 11.3.4.php which was declared as variable to edit record
    {
     ...
     $query = "SELECT * FROM `tbl11_5_9` WHERE `id` = $green_id";
...
<div class="form-group">
    <label for="ppb">Total number of campus practices for sustainable standards of new
builds:</label>
    <textarea class="form-control" id="ppb" name="ppb" rows="1" required><?php echo $ppb ?></textarea>
</div>
...
<button type="reset" class="btn btn-danger mt-6 mb-3" name="cancel" onclick="window.location.href='../11.5.9.php';">
