...
if (isset($_POST['submit'])) {
  ...
  $sql = "INSERT INTO `tbl11_3_7` (`support`, `title`, `desc`,`cost`, `source`,`points`) 
            VALUES ('$support','$title','$desc','$cost','$source','$points')";
...
include "includes/config.php";
$query = "SELECT SUM(points) as total_sum FROM tbl11_3_7";
...
<title>11.3.7 | Other Campus’ Support for Arts and Heritage</title>
...
<!-- END OF HEADER POINTING SYSTEM -->
  ...
  <div class="content">
    <br>
    <h3>11.3.7 Other Campus’ Support for Arts and Heritage</h3>
...
<div class="form-group">
      ...
      <textarea class="form-control" id="support" name="support" rows="1" required></textarea>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="number" class="form-control" id="desc" name="desc" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="cost">Fund Source:</label>
      <input type="number" class="form-control" id="source" name="source" required>
    </div>
...
<div class="table-container">
  ...
  <!--    <th scope="col" style="width: 30px;">#</th> -->
      <th scope="col" style="width: 100px;">Total Number of Other Support for Arts and Heritage</th>
      <th scope="col" style="width: 50px;">Title of PPA</th>
   ...
   <!--   <th scope="col" style="width: 50px;">Points</th>  -->
    ...
    <?php
            include "includes/config.php";
            $query = "SELECT * FROM `tbl11_3_7`"; // SQL query to fetch all table data
          ...
          /*   $query = "SELECT Count(*) AS total FROM `tbl11_3_7`"; // SQL query to fetch all table data
                  $result = mysqli_query($conn, $query); // sending the query to the database
              ...
              //  echo "<td>$points</td>"; 
                ...
                echo "<td style='width:100px'>
                          <a href='edit/edit11.3.7.php?update&other_id={$id}' class='btn btn-primary'>
                              <i class='fa fa-edit'></i> 
                          </a>
                          <a href='delete/delete11.3.7.php?delete={$id}' class='btn btn-danger'>
